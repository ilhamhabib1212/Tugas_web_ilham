            ...
            <div class="box">
                ...
                <table border="1" cellspacing="1" class="table">
                    ...
                    <tbody>
                        <?php
                            $no = 1;
                            $produk = mysqli_query($conn, "SELECT * FROM tb_produk LEFT JOIN tb_category USING (category_id)
                        ...
                        <tr>
                            ...
                            <td><a href="img_produk/<?php echo $row['produk_image']?>"><img src="img_produk/<?php echo $row['produk_image']?>" width="80px" ></a></td>
                            <td><?php echo ($row['produk_status'] == 0)? 'Tidak Aktif':'Aktif'; ?></td>
                            <td>
                                <a href="edit-produk.php ?id=<?php echo $row['produk_id'] ?>"><i class="fa-solid fa-pen-to-square"></i></a> || <a href="
                                delete.php?idp=<?php echo $row['produk_id'] ?> " onclick="return confirm('Delete this data ?')"><i class="fa-solid fa-trash-can"></i></a>
                            </td>
                        </tr>
                        <?php } } else {?>
                            <tr>
